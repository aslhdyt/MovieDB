...
public class DbDetailActivity extends AppCompatActivity {
    ...
    void setLike(boolean l) {
        if(l) {
            ...
            isLike = true;
            ((TextView)findViewById(R.id.textView_like)).setText(me.assel.moviedb.R.string.like_true);

        } else {
            like.setImageDrawable(getResources().getDrawable(R.drawable.unlike));
            like.setTag(R.drawable.unlike);
            isLike = false;
            ((TextView)findViewById(R.id.textView_like)).setText(me.assel.moviedb.R.string.like_false);
        }
    }
